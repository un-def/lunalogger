...
'''
    if js_for_logpage or linkify: foot += '    <script src="/static/js/custom.js"></script>\n'
...
log_line = '''            <li id="{0}" class="log-li"><span class="log-time text-muted">[{1:%H:%M:%S}]</span> {2} <span class="log-message linkify">{3}</span></li>
'''
...
users_user_info_message = '''          <p class="bg-info linkify">
...
####################
# /users/{user}/log/{date}
users_user_log_title = 'Лог сообщений {0} за {1:%d.%m.%Y}'

users_user_log = '''    <div id="log-top" class="container">
      <div class="panel panel-info">
        <div class="panel-heading">
